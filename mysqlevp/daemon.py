...
import signal
import traceback
from .event.stream import MysqlEventStream
from .event.processor import MysqlEventProcessor
from .handler.base import IEventHandler
...
class MysqlevpWrapper(object):
    def __init__(self,
                 ...
                 event_handler,
                 dump_file_path, dump_interval=10,
                 table_filters=None):
        """
        ...
        :param event_handler: the event handler
                              must be an instance derived from mysqlevp.handler.base.IEventHandler
